...
double valor = teclado.nextDouble(); // valor em reais
...
int n1 = (int) ((((((valor % 100) % 50) % 20) % 10) % 5) % 2) / 1; //moeda de 1 R$

double valorCentavos = valor * 100;
int n050 = (int) ((valorCentavos % 100) / 50);
int n025 = (int) (((valorCentavos % 100) % 50) / 25);
int n010 = (int) ((((valorCentavos % 100) % 50) % 25) / 10);
int n005 = (int) (((((valorCentavos % 100) % 50) % 25) % 10) / 5);
int n001 = (int) ((((((valorCentavos % 100) % 50) % 25) % 10) % 5) / 1);
